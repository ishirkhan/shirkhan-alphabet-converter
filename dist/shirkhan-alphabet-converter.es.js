...
function u2uly(word2) {
  return new Uly().convert(word2);
}
function uly2u(word2) {
  return new Uly().forward(word2);
}
function u2khan(word2) {
  return new Khan().convert(word2);
}
function khan2u(word2) {
